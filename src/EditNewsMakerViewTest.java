...
public class EditNewsMakerViewTest {
	...
	/*public static void main(String[] args){
		EditNewsMakerViewTest dong = new EditNewsMakerViewTest();
		dong.getSelectedNewsStoryIndicesTest();
		
		dong.enableRemovalButtonTestEmptyNewsStoryListModel();
		dong.enableRemovalButtonTestNonEmptyNewsStoryListModel();
		dong.enableRemovalButtonTestNullNewsStoryListModel();
		
		dong.actionPerformedTestEmptyNewsStoryListModel();
		dong.actionPerformedTestNonEmptyNewsStoryListModel();
		dong.actionPerformedTestNullNewsStoryListModel();
